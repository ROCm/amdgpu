...
AC_DEFUN([AC_CONFIG_KERNEL], [
	...
	AC_AMDGPU_STRUCT_DRM_MODE_CONFIG_HAS_PANEL_TYPE_PROPERTY
	...
	AC_AMDGPU_PCI_REBAR_GET_MAX_SIZE
	AC_AMDGPU_PCI_RESIZE_RESOURCE
	AC_AMDGPU_KTIME_GET_BOOTTIME_NS
	AC_AMDGPU_US_TO_KTIME
	...
	AC_AMDGPU_SECURITY_LOCKED_DOWN
	AC_AMDGPU_DRM_CACHE
	...
	AC_AMDGPU_DRM_FB_HELPER_GEM_IS_FB
	...
	AC_AMDGPU_DRM_PANEL_BACKLIGHT_QUIRK_FORCE_PWM
	...
	AC_AMDGPU_DRM_COLOR_LUT32
	AC_AMDGPU_STRUCT_DRM_ATOMIC_COMMIT
	AC_AMDGPU_STRUCT_DRM_ATOMIC_STATE_DUPLICATED
	AC_AMDGPU_STRUCT_DRM_ATOMIC_STATE_PLANE_COLOR_PIPELINE
	...
	AC_AMDGPU_DRM_HDMI_INFO_MAX_LANES
	...
	AC_AMDGPU_DMA_FENCE_CHECK_AND_SIGNAL
	...
	AC_AMDGPU_DRM_PRIVATE_STATE_FUNCS_ATOMIC_CREATE_STATE
	AC_AMDGPU_DRM_COLOROP_FUNCS
	AC_AMDGPU_DRM_OUTPUT_COLOR_FORMAT
	...
	AC_AMDGPU_DMA_BUF_INVALIDATE_MAPPINGS
	AC_AMDGPU_ZAP_SPECIAL_VMA_RANGE
	...
	AC_AMDGPU_DMA_FENCE_ARRAY_CREATE
	AC_AMDGPU_DMA_FENCE_DEDUP_ARRAY
	AC_AMDGPU_DMA_FENCE_UNWRAP_MERGE
	AC_AMDGPU_DRM_FILE_ERR
	AC_AMDGPU_DRM_FILE_CLIENT_NAME
	AC_AMDGPU_SIZE_MUL
	AC_AMDGPU_RANGE_OVERFLOWS
	AC_AMDGPU_KMALLOC_OBJ
	AC_AMDGPU_EMPTY_VMA_FLAGS
	AC_AMDGPU_CHECK_SUB_OVERFLOW_BUILTIN
	...
	AC_AMDGPU_SHMEM_FILE_SETUP_VMA_FLAGS
	...
	AC_AMDGPU_DMA_FENCE_SIGNALLING
	AC_AMDGPU_DMA_FENCE_SPINLOCK
	AC_AMDGPU_DMA_FENCE_WAS_INITIALIZED
	...
	AC_AMDGPU_BLKDEV_GET_BY_PATH
	AC_AMDGPU_BLKDEV_GET_BY_PATH_4ARG
	AC_AMDGPU_BDEV_OPEN_BY_PATH
	AC_AMDGPU_BDEV_FILE_OPEN_BY_PATH
	AC_AMDGPU_FILLDIR_RETURNS_INT
	...
	AC_AMDGPU_NR_GPU_ACTIVE
	AC_AMDGPU_4ARGS_LIST_LRU_ADD
	AC_AMDGPU_LIST_LRU_ADD_OBJ
	AC_AMDGPU_LIST_LRU_ONE_LOCK
	AC_AMDGPU_LIST_LRU_EXT
	AC_AMDGPU_3ARGS_LIST_LRU_WALK_CB
	AC_AMDGPU_PCI_DEV_IS_DISCONNECTED
	AC_DRM_EDID_CONNECTOR_ADD_MODES
	AC_DRM_EDID_CONNECTOR_UPDATE
