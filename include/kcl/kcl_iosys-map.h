...
/**
 * iosys_map_rd/wr helpers - backport for kernels < 5.17
 * These macros provide read/write operations for basic C types (u8, u16, u32, u64)
 * from/to iosys_map structures, handling both system memory and MMIO.
 */
#ifdef CONFIG_64BIT
